...
RowVectorPtr SortBuffer::getOutput(int32_t maxOutputRows) {
  VELOX_CHECK(noMoreInput_);
...
void SortBuffer::prepareOutput(int32_t maxOutputRows) {
...
void SortBuffer::getOutputWithoutSpill(int32_t maxOutputRows) {
...
void SortBuffer::getOutputWithSpill(int32_t maxOutputRows) {
