...
class SortBuffer {
 public:
  ...
  RowVectorPtr getOutput(int32_t maxOutputRows);
 ...
 private:
  ...
  void prepareOutput(int32_t maxOutputRows);
  void getOutputWithoutSpill(int32_t maxOutputRows);
  void getOutputWithSpill(int32_t maxOutputRows);
